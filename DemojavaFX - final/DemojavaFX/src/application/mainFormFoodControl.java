...
public class mainFormFoodControl implements Initializable {
	...
	public ObservableList<productData> inventoryDataList() {
		...
		try {
			...
			while (result.next()) {
				prodData = new productData(result.getInt("id"), result.getString("pro_id"),
	...
	private String[] typeList = { "Eat-clean Food", "Fast Food", "Salad - Vegetables", "Fruits" };
	...
	public ObservableList<productData> menuGetData() {
		...
		try {
			...
			while (result.next()) {
				prod = new productData(result.getInt("id"), result.getString("pro_id"), result.getString("pro_name"),
						result.getString("type"), result.getInt("stock"), result.getFloat("price"),
